...
//     {
//         matches = PeakMatcher<T>::matchPeaks(left.getMatchables(), right.getMatchables(), unmatchedLeft, unmatchedRight,
//         [](const Diginstrument::Component<T> &left, const Diginstrument::Component<T> &right)->double
//         {
...
// MomentarySpectrum<T> Diginstrument::Interpolator<T, S>::constructSpectrum(
//     const MomentarySpectrum<T> & left,
//     const MomentarySpectrum<T> & right,
...
//         }
//     }
//     return Diginstrument::MomentarySpectrum<T>(res, {});
// }
...
//template class Diginstrument::Interpolator<double, Diginstrument::MomentarySpectrum<double>>;
//template class Diginstrument::Interpolator<float, Diginstrument::MomentarySpectrum<float>>;
